    ...
    <main class="flex-1 flex flex-col overflow-hidden">
      ...
      <div class="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
        ...
        <div class="flex items-center justify-between pb-4 border-b border-slate-200">
          <div>
            <span class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest block mb-1">ตราสารหนี้</span>
            <h2 class="text-2xl font-black text-slate-800 tracking-tight leading-none">หุ้นกู้ (Debentures)</h2>
          </div>
          <!-- Add Bug Button -->
          <button 
            @click="openAddModal"
...
// Raw Debentures module bug lists
const bugsList = ref([
  { 
    id: 1, 
    bugId: 'UBIV3', 
    title: 'ฟอร์มแก้ไขรายการซื้อขาย', 
    comments: [
      'บันทึกรหัสสาขาธนาคารแล้วระบบไม่บันทึกลง Database', 
      'ไม่มีข้อความแจ้งเตือนสีแดงเมื่อไม่ได้กรอกฟิลด์บังคับ'
    ], 
    expectation: 'ตรงตามดีไซน์ Figma',
    driveLink: 'https://drive.google.com/file/d/3', 
    figmaLink: 'https://figma.com/file/3', 
    status: 'Demo Fail', 
    createdDate: '28/05/2569 11:45',
    fixedDate: '',
    passedDate: ''
  },
  { 
    id: 2, 
    bugId: 'UBIV4', 
    title: 'การคำนวณอัตราดอกเบี้ยสุทธิ', 
    comments: [
      'สูตรคำนวณหักภาษี ณ ที่จ่ายคิดผิดไป 0.01 บาท', 
      'ตรวจสอบทศนิยมให้อยู่ในรูปแบบ 2 ตำแหน่งเท่านั้น'
    ], 
    expectation: 'สูตรภาษีถูกต้องและปัดเศษทศนิยมตามหลักคณิตศาสตร์',
    driveLink: '', 
    figmaLink: 'https://figma.com/file/4', 
    status: 'Pass', 
    createdDate: '29/05/2569 16:30',
    fixedDate: '30/05/2569 10:00',
    passedDate: '30/05/2569 11:30'
  }
])
