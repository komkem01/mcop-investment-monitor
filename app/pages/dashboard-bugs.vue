    ...
    <main class="flex-1 flex flex-col overflow-hidden">
      ...
      <div class="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
        ...
        <div class="flex items-center justify-between pb-4 border-b border-slate-200">
          <div>
            <span class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest block mb-1">บั๊กรายงาน</span>
            <h2 class="text-2xl font-black text-slate-800 tracking-tight leading-none">บั๊กหน้าแดชบอร์ด</h2>
          </div>
          <!-- Add Bug Button -->
          <button 
            @click="openAddModal"
              ...
              <div class="relative min-w-[170px] shrink-0 custom-select-container">
                ...
                >
                  <button 
                    ...
                    class="w-full text-left px-4 py-2 text-xs font-bold text-slate-500 hover:bg-indigo-50/50 hover:text-indigo-650 transition-all"
                  >
                    สถานะทั้งหมด
                  </button>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="space-y-1.5">
              ...
              <input 
                ...
                placeholder="ตัวอย่าง การคำนวณอัตราดอกเบี้ยสุทธิ" 
                class="w-full bg-slate-50/50 border border-slate-200 rounded-2xl px-4 py-3 outline-none focus:border-indigo-400 focus:bg-white focus:shadow-[0_4px_16_rgba(99,102,241,0.03)] transition-all font-semibold text-slate-700"
              />
            </div>
          </div>
    ...
    >
      <div class="bg-white w-full max-w-md rounded-[32px] border border-white/80 shadow-[0_24px_50px_rgba(99,102,241,0.06)] p-6 text-center">
        ...
        <p class="text-xs text-slate-500 font-bold leading-relaxed mb-6">
          คุณกำลังจะลบรายการบั๊ก <span class="text-rose-600 font-black">{{ bugToDelete?.bugId }}</span> ({{ bugToDelete?.title }}) <br>
...
// Summary statistics for Dashboard module bugs
...
// Raw Dashboard module bug lists (matching Excel data mapping)
const bugsList = ref([
  { 
    id: 1, 
    bugId: 'UBIV1', 
    title: 'แบรนดิ้งและสไตล์ Sidebar', 
    comments: [
      'เพิ่มขีดสีฟ้าหน้าคำว่า ลงทุน', 
      'ไอคอนไม่ตรงตาม UI Figma (ให้นำ Emojis ออก)', 
      'สีข้อความไม่สอดคล้องกับธีม (ให้ใช้สีน้ำเงินเข้มข้นขึ้น)'
    ], 
    expectation: 'ตรงตามดีไซน์ Figma',
    driveLink: 'https://drive.google.com/file/d/1', 
    figmaLink: 'https://figma.com/file/1', 
    status: 'Defect', 
    createdDate: '26/05/2026 22:20:51',
    fixedDate: '',
    passedDate: ''
  },
  { 
    id: 2, 
    bugId: 'UBIV2', 
    title: 'สไตล์หน้าหุ้นกู้และปฏิทิน', 
    comments: [
      'วันที่ของ ราคาหุ้นปิดเมื่อวาน ไม่ตรงตาม Figma', 
      'UI ไม่ตรงตาม figma วันครบกำหนดไถ่ถอน', 
      'UI ไม่ตรงตาม figma Dropdown ตัวกรอง', 
      'ไม่มีโมดูลปฏิทินไถ่ถอนรายเดือน', 
      'ไม่มีโมดูลแสดงวงเงินคงเหลือธนาคาร', 
      'การแสดงค่า ณ วันที่... ไม่สอดคล้องกับ UI Figma'
    ], 
    expectation: 'ตรงตามดีไซน์ Figma',
    driveLink: 'https://drive.google.com/file/d/2', 
    figmaLink: 'https://figma.com/file/2', 
    status: 'Defect', 
    createdDate: '27/05/2026 09:01:16',
    fixedDate: '',
    passedDate: ''
  }
])
